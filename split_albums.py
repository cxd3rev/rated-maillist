...
source = root.joinpath("script.js").read_text(encoding="utf-8")
...
root.joinpath("albums.js").write_text(albums_js, encoding="utf-8")

app_js = marker + app_part
root.joinpath("script.js").write_text(app_js, encoding="utf-8")
